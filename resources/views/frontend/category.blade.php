                      ...
                      <div class="grid_item">
                        ...
                        <figure>
                          ...
                          <a href="{{url('shop/'.$item->slug)}}">
                            <img class="img-fluid lazy loaded" width="250px" height="250px" src="{{asset('backend/images/products/'.$item->product_image)}}" data-src="frontend/img/products/p1.jpg" alt="" data-was-processed="true">
                          </a>
              ...
              <div class="filter_col">
                  ...
                  <div class="filter_type version_2">
                    ...
                    <div class="collapse show" id="filter_1">
                      <ul>
                        @foreach($categorys as $citem)
                        <li>
                        <label class="container_check">{{$citem->title}} <small>12</small>
                        <input type="checkbox" value="{{$citem->id}}" class="checkbox" name="category">
                  ...
                  <div class="filter_type version_2">
                    ...
                    <div class="collapse" id="filter_3">
                      <ul>
                        ...
                        <li>
                        <label class="container_check">{{$bitem->title}} <small>11</small>
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                        </li>
