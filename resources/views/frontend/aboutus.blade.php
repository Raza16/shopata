      ...
      <div class="container margin_60">
        ...
        <div class="owl-carousel owl-theme carousel_centered owl-loaded owl-drag">
          ...
          <div class="owl-stage-outer">
            ...
            <div class="owl-stage" style="transition: all 0s ease 0s; width: 3900px; transform: translate3d(-750px, 0px, 0px);">
                  ...
                  <div class="owl-item cloned" style="width: 290px; margin-right: 10px;">
                    <div class="item">
                      <a href="#0">
                        ...
                        <img src="{{asset('frontend/img/staff/2_carousel.jpg')}}" alt="">
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="owl-item cloned" style="width: 290px; margin-right: 10px;">
                    <div class="item">
                      <a href="#0">
                        ...
                        <img src="{{asset('frontend/img/staff/3_carousel.jpg')}}" alt="">
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="owl-item cloned" style="width: 290px; margin-right: 10px;">
                    <div class="item">
                      <a href="#0">
                        ...
                        <img src="{{asset('frontend/img/staff/4_carousel.jpg')}}" alt="">
                      </a>
                    </div>
                  </div>

                  <div class="owl-item cloned active" style="width: 290px; margin-right: 10px;">
                    <div class="item">
                      <a href="#0">
                        <div class="title">
                          <h4>Andrew Stuttgart<em>Admissions</em></h4>
                        </div>
                        <img src="{{asset('frontend/img/staff/5_carousel.jpg')}}" alt="">
                      </a>
                    </div>
                  </div>

                  <div class="owl-item active center" style="width: 290px; margin-right: 10px;">
                    <div class="item">
                      <a href="#0">
                        <div class="title">
                          <h4>Julia Holmes<em>CEO</em></h4>
                        </div>
                        <img src="{{asset('frontend/img/staff/1_carousel.jpg')}}" alt="">
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="owl-item" style="width: 290px; margin-right: 10px;">
                    <div class="item">
                      <a href="#0">
                        <div class="title">
                          <h4>Pablo Himenez<em>Customer Service</em></h4>
