...
@section('content')
  ...
  <div class="page-header">
    ...
    <a type="button" class="btn btn-info btn-fw" href="{{url('admin/banner/create')}}"><i class="icon-plus"></i>&nbsp;Banner Add</a>
                      ...
                      <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                        ...
                        <thead>
                            ...
                            <tr role="row">
                              ...
                              <th class="sorting_asc" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Order #: activate to sort column descending" style="width: 58px;">Image</th>

                              <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 103px;">Banner Status</th>
                              ...
                              <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" style="width: 61px;">Delete</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    ...
                                    <a type="button" href="{{url('admin/banner/'.$banner->id.'/edit')}}" style="padding:10px" class="btn btn-md btn-primary btn-icon-text">
